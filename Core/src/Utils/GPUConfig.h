...
class GPUConfig
{
    ...
    private:
	    ...
	    icpStepMap["GeForce GTX 1050 with Max-Q Design"] = std::pair<int, int>(64, 240);
rgbStepMap["GeForce GTX 1050 with Max-Q Design"] = std::pair<int, int>(32, 112);
rgbResMap["GeForce GTX 1050 with Max-Q Design"] = std::pair<int, int>(48, 352);
so3StepMap["GeForce GTX 1050 with Max-Q Design"] = std::pair<int, int>(64, 80);
